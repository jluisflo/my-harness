...
2. **TECH.md** — Decisiones tecnicas: stack por proyecto afectado, patrones a seguir, dependencias nuevas, riesgos. Si el feature involucra comunicacion entre servicios, incluye el contrato de interfaz como seccion con bloque JSON.
...
3. Produce los 3 artefactos en orden: PRODUCT.md > TECH.md (con contrato si aplica) > TASK.md
4. Si el PRD de negocio tiene ambiguedades, documenta las preguntas en PRODUCT.md — no asumas sin declarar
...
- Si hay contrato de interfaz en TECH.md, ese es la fuente de verdad para las interfaces. Si PRODUCT.md y el contrato se contradicen, el contrato gana.
...
- No produces artefactos parciales — los 3 o nada
